...
ALTER TABLE Empresa ADD CONSTRAINT Relationship6 FOREIGN KEY (CPF_CNPJ) REFERENCES Usuario (CPF_CNPJ) ON DELETE CASCADE ON UPDATE CASCADE
;

ALTER TABLE Candidato ADD CONSTRAINT Relationship9 FOREIGN KEY (CPF_CNPJ) REFERENCES Usuario (CPF_CNPJ) ON DELETE CASCADE ON UPDATE CASCADE
;

ALTER TABLE Formacao_Academica ADD CONSTRAINT Relationship19 FOREIGN KEY (CPF) REFERENCES Candidato (CPF_CNPJ) ON DELETE NO ACTION ON UPDATE NO ACTION
;
...
ALTER TABLE Experiencia_Profissional ADD CONSTRAINT Relationship21 FOREIGN KEY (CPF) REFERENCES Candidato (CPF_CNPJ) ON DELETE NO ACTION ON UPDATE NO ACTION
;
...
ALTER TABLE Cargo_Interesse ADD CONSTRAINT Relationship34 FOREIGN KEY (CPF) REFERENCES Candidato (CPF_CNPJ) ON DELETE NO ACTION ON UPDATE NO ACTION
;
...
ALTER TABLE Candidato_Vaga ADD CONSTRAINT Relationship42 FOREIGN KEY (CPF) REFERENCES Candidato (CPF_CNPJ) ON DELETE NO ACTION ON UPDATE NO ACTION
;
...
ALTER TABLE Vaga ADD CONSTRAINT Relationship46 FOREIGN KEY (CNPJ) REFERENCES Empresa (CPF_CNPJ) ON DELETE NO ACTION ON UPDATE NO ACTION
;

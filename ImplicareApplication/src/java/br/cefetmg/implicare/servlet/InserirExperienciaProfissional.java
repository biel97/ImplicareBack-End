...
public class InserirExperienciaProfissional extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            Result.setStatusOK();
            Result.setContent(ExperienciaProfissionalManagement.insert(ExperienciaProfissional));
            
        } catch (BusinessException | PersistenceException ex) {
            ex.printStackTrace();
            Logger.getLogger(InserirExperienciaProfissional.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public String getServletInfo() {
        return "Insert ExperienciaProfissional";
    }

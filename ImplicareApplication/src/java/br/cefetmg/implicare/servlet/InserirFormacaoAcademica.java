...
public class InserirFormacaoAcademica extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            Result.setStatusOK();
            Result.setContent(FormacaoAcademicaManagement.insert(FormacaoAcademica));
            
        } catch (BusinessException | PersistenceException ex) {
            ex.printStackTrace();
            Logger.getLogger(InserirFormacaoAcademica.class.getName()).log(Level.SEVERE, null, ex);
